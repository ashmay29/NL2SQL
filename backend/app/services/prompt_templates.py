...
def build_ir_prompt(
    ...
    prompt_parts.extend([
        ...
        "",
        "For DATE_SUB/DATE_ADD (date arithmetic):",
        "{\"type\": \"function\", \"function\": \"DATE_SUB|DATE_ADD\", \"args\": [{date_expr}, {\"type\": \"literal\", \"value\": \"INTERVAL 30 DAY\", \"data_type\": \"string\"}]}",
        "IMPORTANT: For DATE_SUB/DATE_ADD, use format 'INTERVAL n UNIT' where UNIT is DAY, MONTH, YEAR, HOUR, etc. (no quotes around INTERVAL)",
        "",
